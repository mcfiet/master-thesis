...
Die qualitative Fehleranalyse deckte auf, dass reine Embedding-Metriken blind für isolierte Faktenverzerrungen und erfundene Erklärungen bleiben. Um die inhaltliche Zuverlässigkeit generativer Übersetzungen abzusichern, müssen automatisierte Belohnungsfunktionen im DPO-Training künftig um Modelle zur natürlichen Sprachinferenz (Natural Language Inference, NLI) und Konsistenzprüfungen erweitert werden. Ein solches Mehrebenen-Signal kann inhaltliche Widersprüche und unbelegte Zusatzaussagen gezielt sanktionieren und so formale Einfachheit mit verlässlicher Faktentreue verbinden.
