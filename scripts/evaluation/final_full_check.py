...
mapping = [
    ...
    ("notebooks/experiments/textcomplexityde.ipynb", "results/evaluation/textcomplexityde_eval.csv", "scripts/sbatch/experiments/textcomplexityde/1_evaluate_textcomplexityde.sh"),
    ("notebooks/experiments/length_bias.ipynb", "results/evaluation/length_bias_results.csv", "scripts/sbatch/experiments/length_bias/1_check_length_bias.sh"),
    ("notebooks/archive/metric/compare_bilstm_vs_rnn_baseline.ipynb", "results/evaluation/bilstm_vs_rnn_eval.csv", "scripts/sbatch/experiments/rnn_baseline/2_evaluate_rnn_baseline.sh"),
    ("notebooks/archive/metric/compare_mixup_synthetic_lh_kde.ipynb", "results/evaluation/mixup_synthetic_kde_eval.csv", "scripts/sbatch/experiments/synthetic_regressor/8_evaluate_synthetic_kde.sh"),
    ("notebooks/archive/metric/compare_mixup_vs_synthetic.ipynb", "results/evaluation/mixup_vs_synthetic_unbiased_eval.csv", "scripts/sbatch/experiments/synthetic_regressor/7_evaluate_synthetic_experiments.sh"),
