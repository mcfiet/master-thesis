...
mapping = [
    ...
    ("notebooks/experiments/loss_aggregation.ipynb", "results/evaluation/loss_aggregation_comparison_summary.csv", "scripts/sbatch/experiments/archive/loss_aggregation/2_run_full_evaluation.sh"),
    ...
    ("notebooks/archive/metric/compare_mixup_synthetic_lh_kde.ipynb", "results/evaluation/mixup_synthetic_kde_eval.csv", "scripts/sbatch/experiments/metric/synthetic_regressor/5_evaluate_synthetic_kde.sh"),
    ("notebooks/archive/metric/compare_mixup_vs_synthetic.ipynb", "results/evaluation/mixup_vs_synthetic_unbiased_eval.csv", "scripts/sbatch/experiments/metric/synthetic_regressor/4_evaluate_synthetic_experiments.sh"),
