...
class MetricWeightsEvaluator:
    ...
    def evaluate_model(
        ...
        # Load Tokenizer
        tokenizer = AutoTokenizer.from_pretrained(model_name_or_path if os.path.exists(os.path.join(model_name_or_path, "tokenizer_config.json")) else base_model_name)
