...
| **05** | **TextComplexityDE Validierung**          | `sbatch scripts/sbatch/experiments/metric/textcomplexityde/1_evaluate_textcomplexityde.sh`          | Externe Validierung des MixUp-Regressors auf dem standardisierten Benchmark                              |
