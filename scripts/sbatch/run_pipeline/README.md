...
* **Temperature Ladder 500 Tokens:** [`scripts/sbatch/experiments/temperature_ladder_500/`](../experiments/temperature_ladder_500/)
* **Token Length (256 vs 512 vs 1024):** [`scripts/sbatch/experiments/token_length/`](../experiments/token_length/)
* **Token Length mit Jina Embeddings:** [`scripts/sbatch/experiments/token_length_jina/`](../experiments/token_length_jina/)
* **Length Bias Analyse:** [`scripts/sbatch/experiments/length_bias/`](../experiments/length_bias/)
...
* **MixUp Data Scaling:** [`scripts/sbatch/experiments/data_scaling/`](../experiments/data_scaling/)
...
* **Faktentreue & Halluzinationserkennung:** [`scripts/sbatch/experiments/factuality_metric/`](../experiments/factuality_metric/)
* **TextComplexityDE Externe Validierung:** [`scripts/sbatch/experiments/textcomplexityde/`](../experiments/textcomplexityde/)
