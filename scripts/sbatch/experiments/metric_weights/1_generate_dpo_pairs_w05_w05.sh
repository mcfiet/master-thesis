#!/bin/bash
#SBATCH --job-name=1_gen_dpo_w05_w05
...
OUTPUT_FILE="data/metric_weights_exp/dpo_pairs_w05_w05_shard_${SHARD_ID}.jsonl"

echo "=== Generating DPO Preference Pairs w05_w05 (Shard ${SHARD_ID}/${NUM_SHARDS}) ==="
date
