#!/bin/bash
#SBATCH --job-name=train_mixup_256
...
srun python scripts/modeling/regression_train_mixup.py \
    ...
    --min_sim 0.80 \
    --max_sim 0.98 \
    --model_save_path results/models/regressor_length_exp/bilstm_mixup_regression_256.pt \
    --vocab_save_path data/regressor_length_exp/mixup_vocab_256.json \
