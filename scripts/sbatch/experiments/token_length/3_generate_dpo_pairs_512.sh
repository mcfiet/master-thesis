#!/bin/bash
#SBATCH --job-name=3_generate_dpo_pairs_512
...
OUTPUT_FILE="data/token_length_exp/dpo_pairs_len512_shard_${SHARD_ID}.jsonl"

echo "=== Starting Token Length 512 DPO Generation (Shard ${SHARD_ID}/${NUM_SHARDS}) ==="
date

srun python scripts/modeling/generate_dpo_dataset.py \
    --corpus_path "data/corpus/corpus_10kgnad_len512_as.json" \
    --sft_model_path "results/models/token_length_exp/sft_len512" \
