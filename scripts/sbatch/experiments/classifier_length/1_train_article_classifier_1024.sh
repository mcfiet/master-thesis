#!/bin/bash
#SBATCH --job-name=train_art_clf_1024
...
srun python scripts/modeling/binary_train_article_model.py \
    ...
    --max_sim 0.98 \
    --min_sent_len 4 \
    --model_save_path results/models/classifier_length_exp/bilstm_article_classifier_1024.pt \
    --vocab_save_path data/classifier_length_exp/article_vocab_1024.json \
