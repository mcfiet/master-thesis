...
parser.add_argument('--log_dir', default="results/logs/experiments/rnn_baseline", help="Directory where logs are stored")
parser.add_argument('--plot_dir', default="results/plots/experiments/rnn_baseline", help="Directory where plots are stored")
