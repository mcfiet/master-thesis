...
def main():
    ...
    aligned_urls_path = os.path.join("data", "corpus", "1_aligned_urls", "hamburg_aligned_urls.json")
    ...
    output_file = os.path.join("data", "corpus", "2_raw_scraped", "hamburg_articles.json")
