...
def main():
    ...
    aligned_urls_path = os.path.join("data", "corpus", "1_aligned_urls", "sozialpolitik_aligned_urls.json")
    if not os.path.exists(aligned_urls_path):
        aligned_urls_path = os.path.join("results", "aligned_urls", "sozialpolitik_aligned_urls.json")
    ...
    for i, pair in enumerate(data['pairs']):
        ...
        if ls_response:
            ...
            ls_text = extract_sp_content(ls_soup)
        ...
        if as_response:
            ...
            as_text = extract_sp_content(as_soup)
    ...
    output_file = os.path.join("data", "corpus", "2_raw_scraped", "sozialpolitik_articles.json")
