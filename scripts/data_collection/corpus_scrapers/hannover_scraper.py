...
def main():
    ...
    aligned_urls_path = os.path.join("data", "corpus", "1_aligned_urls", "hannover_aligned_urls.json")
    if not os.path.exists(aligned_urls_path):
        aligned_urls_path = os.path.join("results", "aligned_urls", "hannover_aligned_urls.json")
    output_file = os.path.join("data", "corpus", "2_raw_scraped", "hannover_articles.json")
