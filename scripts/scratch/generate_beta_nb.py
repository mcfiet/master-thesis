 ...
 "cells": [
  ...
  },
  {
   ...
   "source": [
    ...
    "\n",
    "REPO_ROOT = os.getcwd()\n",
    "print('Arbeitsverzeichnis:', REPO_ROOT)\n",
    "\n",
...
with open("notebooks/research/translation/analyse_dpo_beta_experiment.ipynb", "w", encoding="utf-8") as out:
    json.dump(nb_data, out, indent=1, ensure_ascii=False)

print("Updated notebook via generator.")
